...
#
import numpy as np
from nomad.metainfo import MSection, MCategory, Category, Package, Quantity, Section, SubSection
...
class BasisSet(simulation.method.BasisSet):
    ...
    x_abacus_section_specie_basis_set = SubSection(
        sub_section=x_abacus_section_specie_basis_set,
        repeats=True)
...
class Run(simulation.run.Run):
    ...
    x_abacus_section_parallel = SubSection(
        sub_section=x_abacus_section_parallel,
        repeats=True)
