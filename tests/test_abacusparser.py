...
def test_dos(parser):
    archive = EntryArchive()
    parser.parse('tests/data/Si_dos/running_nscf.log', archive, None)
...
def test_scf(parser):
    archive = EntryArchive()
    parser.parse('tests/data/Si_scf/running_scf.log', archive, None)
...
def test_geomopt(parser):
    archive = EntryArchive()
    parser.parse('tests/data/Si_geomopt/running_cell-relax.log', archive, None)
...
def test_md(parser):
    archive = EntryArchive()
    parser.parse('tests/data/Sn_md/running_md.log', archive, None)
...
def test_hse(parser):
    archive = EntryArchive()
    parser.parse('tests/data/GaSb_hse/running_scf.log', archive, None)
...
def test_spin2(parser):
    archive = EntryArchive()
    parser.parse('tests/data/Si_spin2/running_nscf.log', archive, None)
    sec_run = archive.run[0]
...
def test_dftu(parser):
    archive = EntryArchive()
    parser.parse('tests/data/MnBiTe_dftu/running_scf.log', archive, None)
